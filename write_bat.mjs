...
const batPath = path.join('RibbonBridge_Dist', '🎁[필독]새_리본프린터_자동설치(더블클릭).bat')
...
console.log('Writing batch file with UTF-8 BOM encoding...')
fs.writeFileSync(batPath, batContent, 'utf8')
console.log('Done writing batch file.')
